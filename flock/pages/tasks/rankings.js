...
const Ranking = () => {
	...
	const eloRankings = (fb_data) => {
		let dogs = {}
		Object.values(fb_data[0].val()).map((dog) => {
			dogs[dog["name"]] = {
				"score": 1500,
				"pic": dog["picture"]
			}
		...
		Object.values(snapshots[2].val()).map((matchup) => {
			if (matchup["feature"] === 1) {

				const winner_name = Object.values(fb_data[0].val())[matchup["winner"]]["name"]
				const loser_name = Object.values(fb_data[0].val())[matchup["loser"]]["name"]

				const currentScore_winner = dogs[winner_name]["score"]
				const currentScore_loser = dogs[loser_name]["score"]
				...
				dogs[winner_name]["score"] = updatedScore_winner
				dogs[loser_name]["score"] = updatedScore_loser
			}
		})
			...
			<div className="container">
				...
				<div className="row">
					...
					<div className="col">
						...
						<ul>
							{
								Object.values(history).sort((a, b) => {
